...
describe('POST /api/get-cell-images', () => {
  let POST;
  ...
  const fixture = { rawImage: 'cmF3', processedImage: 'cHJvYw==' };
  ...
  function makeRequest({
    ...
    return new Request('http://localhost/api/get-cell-images', {
      method: 'POST',
      headers,
  ...
  it('forwards the parsed body and X-Access-Code header to the upstream fetch', async () => {
    ...
    expect(global.fetch).toHaveBeenCalledWith(
      'https://api.example.com/mylossrun/get-cell-images',
